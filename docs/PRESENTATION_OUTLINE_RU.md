...
## Опциональный слайд. Командный вклад (мягкая формулировка)
...
- при наличии скрина истории Kaggle submissions можно отдельной подписью показать, что основной поток контрольных A/B-сабмитов шёл через этот же интеграционный контур (без точных процентов, если их не фиксировали)
